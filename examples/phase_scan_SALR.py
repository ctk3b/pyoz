...
def run(eps, NaCl_wt_perc, SiO2_wt_perc, m=100, n=50, T=298, prefix=''):
    ...
    fn = 'scan/{}eps_{:.5f}-rho_{:.3f}-m_{}-n_{}.pkl'.format(prefix, eps, rho, m, n)
...
if __name__ == '__main__':
    ...
    all_files = glob.glob('scan/{}eps*.pkl'.format(run_prefix))
