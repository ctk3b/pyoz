...
def test_two_comp_picard():
    ...
    r = lj_liquid.r
    lj_liquid.add_interaction(0, 0, oz.lennard_jones(r, eps[0] / T, sig[0]))
    lj_liquid.add_interaction(1, 1, oz.lennard_jones(r, eps[1] / T, sig[1]))

    eps_01 = oz.geometric(eps[0], eps[1])
    sig_01 = oz.arithmetic(sig[0], sig[1])
    lj_liquid.add_interaction(0, 1, oz.lennard_jones(r, eps_01 / T, sig_01))
